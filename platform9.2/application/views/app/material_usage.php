                ...
                <div class="modal-content model_wrap" style="position:relative">
                    <div class="model_content" >
                        ...
                        <div class="modal-body building add_Item" >
                            ...
                            <div class="search_person_wrap">
                                <div class="oh" style="margin-bottom:10px;">
                                    <div class="fl">
                                        ...
                                        <form class=" col-sm-9  " role="form" style="position:absolute;z-index:99;width:500px;margin-left:80px;height:100px;overflow:auto;" >
                                            <div class="form-group" >
                                                <label for="basic" class="col-lg-2 "></label>
                                                <div class="col-sm-9">
                                                    <select class="selectpicker" style="height：30px; line-height:30px; " id="basic" class="selectpicker " data-live-search="true">
                                                        <option>无</option>
                            ...
                            <p style="margin-top:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：<input type="text" class="model_input remark" placeholder="请输入备注内容" name="remark" /></p>
                        </div>
                    </div>
