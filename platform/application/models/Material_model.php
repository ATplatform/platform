...
class Material_model extends CI_Model
{
                ...
                foreach ($arr as $key => $value) {
                    foreach ($value as $key2 => $value2) {
                        ...
                        elseif ($key2 == 'm_name') {
                            ...
                            $arr[$key][$key2] = intval($value2, 10);
                        } elseif ($key == 'mm_remark') {
                            $arr[$key]['remark'] = $value2 ? $value2 : '无';
                        }
                    }
                }
    ...
    {
       /* $sql = "select count(*) as count from village_material M left join village_building_stage AS bs ON M .building_code = bs.room_code";
        $sql .= " LEFT JOIN village_building AS b ON M .building_code = b.code";
        $sql .= " where b.effective_date =(select max(effective_date) from village_building A where b. name=A.name and b.parent_code=A.parent_code and A.effective_status=TRUE) and b.effective_status = TRUE";*/
