...
public function insert($village_id,$code,$type,$name,$person_code,$service_code, $begin_date,$end_date,$qr_code,$create_time)
{

    $sql = " INSERT INTO village_activity (village_id,code,type,name,person_code,service_code, begin_date,end_date,qr_code,create_time) values (".
