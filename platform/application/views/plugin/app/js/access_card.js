...
$(document).on('click','.search_person_only .single_person .add',function(){
	...
	var html = '<li data-last_name="'+last_name+'" data-first_name="'+first_name+'" data-code="'+code +'"><span class="full_name">'+full_name+'</span><span class="id_number">'+id_number+'</span><i class="fa fa-close"></i></li>';
		//最多添加十个且不能重复添加
