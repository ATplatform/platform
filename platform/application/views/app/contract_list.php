    ...
    <div class="searc_bar search_wrap " id="search_wrap" >
      ...
      <!--  <a href="javascript:;" id="treeNav" class="treeWrap treeWrapSearch"><span></span></a>-->
        ...
        <form class="search_room" action="" method="get">
            <p>
                <input type="text" class="searc_room_text" name="keyword" placeholder="可输入合同编号、签订对象进行搜索" title="可输入合同编号、签订对象进行搜索" value="">  <a id="clear" onclick="return false">X</a>
            </p>
    ...
    <!-- 物资数据-->
        <div class="table_wrap">
           <div class="oh pt10">
                ...
                <a class="fr add_btn" href="<?=base_url().'index.php/Contract/contractList'?>">清除筛选</a>
            </div>
            <table id="table"
