...
<!--<?php echo 'x'; ?>-->
    ...
    <div class="searc_bar search_wrap " id="search_wrap" >
        ...
        <!-- 筛选条件 时间-->
        <input type="text" class="select_time date col_37A fl form-control" name="date"  value="">
    ...
    <!-- 物资数据-->
        <div class="table_wrap">
           <div class="oh pt10">
                ...
                <a class="fr add_btn" href="<?=base_url().'index.php/Activity/activityRecord'?>">清除筛选</a>
            </div>
            <table id="table"
                ...
                <tr>
                    ...
                    <th  data-title="物业负责人" data-align="center" data-field="rcd_service_name"></th>
                    <th data-title="参与的业主" data-align="center" data-formatter="viewAll" data-field="rcd_person_name"></th>
                    <th  data-title="活动日期" data-align="center" data-field="date_name"></th>
        ...
        <ul class="pager" page=''>
            ...
            <li class="prevpage"><a href='' id='prev' >上一页</a></li>
            <li class="disabled"><a href='javascript:void(0);' id='current'></a></li>
            <li class="nextpage"  ><a  id='next' href=''>下一页</a></li>
                ...
                <div class="modal-content model_wrap">
                    <div class="model_content">
                        <div class="building_header">
                            <h4 class="modal-title tac">新增活动记录</h4>
                        </div>
                        <div class="modal-body building add_Item">
                            <div class="select_pull_down select_wrap select_room select_activity">
                                <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动编号：
                                    <input type="text" class="model_input code ka_input3" placeholder="请输入活动编号" name="code" data-ajax="" readonly="">
                                </div>
                            ...
                            <p><span class="red_star">*</span>活动日期：
                                <input type="text" class="date form-control" name="date" value=""/ >
                            </p>
                            <div class="select_pull_down select_wrap select_room select_person">
                                <div>
                            ...
                            <div class="search_person_wrap" >
                                <div class="oh" style="margin-bottom:10px;">
                                    <div class="fl">
                                        <span class="red_star">*</span>参与的业主：
                                    </div>
                                    <div class="fl search_person_text" style="margin-left:28px;">
                                        <input type="text" class="fl person_code search_person_name" placeholder="请输入姓名查找" name="person_code" style="width:300px;font-size:inherit;">
                            ...
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;备注：
                                <input type="text" class="model_input supplier" placeholder="请输入备注"  name="remark" />
                            </p>
                    </div>
                    </div>
        ...
        <div class="modal fade" id="person_detail" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog"  style="width: 700px;">
                <div class="modal-content model_wrap">
                    <div class="model_content">
                        <div class="building_header">
                            <h4 class="modal-title tac">活动记录详情</h4>
                        </div>
                        <div class="modal-body building oh">
                            <div class=" person_wrap person_detail" style="width:600px;">
                                ...
                                <p><span class="des">日期:</span>
                                    <span class="date_name    col_37A"></span>
                                </p>
                            <!--    <p><span class="des">结束日期:</span>
                                ...
                                <p><span class="des">参与的住户:</span>
                                    <span class="rcd_person_name col_37A"></span>
                                </p>
                                <p><span class="des">物业负责人:</span>
                                    <span class="rcd_service_name col_37A"></span>
                                </p>
...
<input type="hidden" value='<?php echo $total;?>' name="totals" />
<input type="hidden" value='<?php echo $total;?>' name="total" />
<input type="hidden" value='<?php echo $keyword;?>' name="keywords" />
<input type="hidden" value='<?php echo $date;?>' name="dates" />
...
<script src='<?=base_url().'application/views/plugin/app/js/activity_record.js'?>'></script>
</body>
</html>