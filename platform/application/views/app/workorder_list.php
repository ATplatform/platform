...
<!--<?php echo 'x'; ?>-->
    ...
    <div class="searc_bar search_wrap " id="search_wrap" >
        ...
        <div class="Search_Item_wrap search_wrap_1 select_pull_down query_wrap col_37A fl"  style="margin-right:10px;">
            <div >
                <input type="text"  class="model_input search_1 ka_input3" placeholder="创建类型" name="create_type" data-ajax="" value="" readonly style="width:150px;" >
            </div>
        ...
        <div class="Search_Item_wrap search_wrap_2 select_pull_down query_wrap col_37A fl">
            <div >
                <input type="text"  class="model_input search_2 ka_input3" placeholder="工单类型" name="order_type" data-ajax="" value="" readonly style="width:100px;" >
            </div>
        ...
        <form class="search_room" action="" method="get">
            <p>
                <input type="text" class="searc_room_text" name="keyword" placeholder="可输入工单编号、创建人..." value="" title="可输入工单编号、创建人、接单人"><a id="clear" onclick="return false">X</a>
            </p>
    ...
    <!-- 物资数据-->
        <div class="table_wrap">
            <div class="oh pt10">
                <a class="fr add_btn" href="<?=base_url().'index.php/Workorder/workorderList'?>">清除筛选</a>
            </div>
            <table id="table"
