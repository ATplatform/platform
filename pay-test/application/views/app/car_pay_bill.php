...
<div class="main">
    <div class="car_bill_wrap">
        <div><span class="car_licence">粤B.6W888</span><span  class="pay_money">￥20</span></div>
        <div class="car_place"><span class="park_lot">南昌智汇谷小区</span>  <span>1号停车场</span> </div>
        <img src="<?=$basic_url.'online_month_card_pic.png'?>" alt="" class="place_img">
        <div class="in_time_wrap"><span class="in_time_title">入场时间：</span><span class="in_time">09/10 10:30</span>  </div>

        <div class="out_time_wrap"><span  class="out_time_title">停车时间：</span><span class="out_time">09/10 10:30 至 09/10 11:30</span> </div>
        <br>
        ...
        <div class="pay clearfloat">
            <div class="pay_info fl clearfloat">
             <!--   <div class="pay_info_wrap fl">
                ...
                <div class="total_wrap fl"><span class="total">合计:&nbsp; &nbsp;<span class="total_money">￥0</span></span></div>
            </div>
...
<script>
    $('.top-wrap .left').click(function(){
        window.location.href=getRootPath()+'/index.php/pay_h5/car_pay_h5?person_code=100094&village_id=100001'
    })
