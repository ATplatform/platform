	...
	<div class="col-sm-12 main_wrap">
		...
		<div class="table_wrap">
			<div class="oh pt10">
				...
				<a class="fr add_btn" href="<?=base_url().'index.php/People/managementlist'?>">清除筛选</a>
			</div>
        ...
        <div class="modal-content model_wrap">
        	<div class="model_content">
				...
				<p><span class="red_star">*</span>入职日期：
					<input type="text" class="hire_date date form-control" name="hire_date" placeholder="请选择入职日期" >
				</p>
				...
				<p><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;员工编号：</span>
					<input type="text" class="employee_no" name="employee_no" placeholder="请填写员工编号" >
				</p>
