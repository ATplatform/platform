    ...
    <!-- 物资数据-->
        <div class="table_wrap">
            <div class="oh pt10">
                ...
                <a class="fr add_btn" href="<?=base_url().'index.php/Material/materialUsage'?>">清除筛选</a>
            </div>
            <table id="table"
        ...
        <div class="modal fade" id="add_Item" tabindex="-1" role="dialog" aria-hidden="true" >
            <div class="modal-dialog"  style="width: 620px;">
                <div class="modal-content model_wrap" style="position:relative">
                        ...
                        <div class="modal-body building add_Item" >
                            ...
                            <div class="search_person_wrap">
                                <div class="oh" style="margin-bottom:10px;">
                                    ...
                                    <div class="fl search_person_text" style="margin-left:12px;font-size:inherit;">
                                        <input  style="width:344px;font-size:inherit;" type="text" class="fl search_person_name" placeholder="请输入姓名查找" >
...
<script>
    ...
    console.log( $('.btn-group .bootstrap-select'))
