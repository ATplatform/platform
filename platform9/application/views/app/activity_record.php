...
<!--<?php echo 'x'; ?>-->
    ...
    <!-- 物资数据-->
        ...
        <ul class="pager" page='<? $page ?>'>
            <?php
            $first=base_url().'index.php/Activity/activityRecord?page=1&type='.$type.'&keyword='.$keyword.'&date='.$date;
            echo  " <li><a href='".$first."' id='first'>首 页</a></li>";
            if($page>1) {
                $url=base_url().'index.php/Activity/activityRecord?page='.($page-1).'&type='.$type.'&keyword='.$keyword.'&date='.$date;
            ...
            $last=base_url().'index.php/Activity/activityRecord?page='.$total.'&type='.$type.'&keyword='.$keyword.'&begin_date='.$date;
                            ...
                            <div class="search_person_wrap">
                                <div class="oh" style="margin-bottom:10px;">
                                    ...
                                    <div class="fl search_person_text">
                                        <input type="text" class="fl person_code" placeholder="请输入姓名查找" name="person_code" style="width:300px;">
