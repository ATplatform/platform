...
<!--<?php echo 'x'; ?>-->
    ...
    <!-- 物资数据-->
        ...
        <ul class="pager" page='<? $page ?>'>
            <?php
            $first=base_url().'index.php/Activity/activityList?page=1&type='.$type.'&keyword='.$keyword.'&begin_date='.$begin_date;
            echo  " <li><a href='".$first."' id='first'>首 页</a></li>";
            if($page>1) {
                $url=base_url().'index.php/Activity/activityList?page='.($page-1).'&type='.$type.'&keyword='.$keyword.'&begin_date='.$begin_date;
            ...
            $last=base_url().'index.php/Activity/activityList?page='.$total.'&type='.$type.'&keyword='.$keyword.'&begin_date='.$begin_date;
                        ...
                        <div class="modal-body building add_Item">
                            ...
                            <div class="search_person_wrap">
                                <div class="oh" style="margin-bottom:10px;">
                                    <div class="fl">
                                        <span class="red_star">*</span>感兴趣的业主：
                                    </div>
                                    <div class="fl search_person_text">
                                        <input type="text" class="fl search_person_name" placeholder="请输入姓名查找" style="width:300px;">
