...
";
    ...
    //////////////////////搜索查询数据数目的数据总条数/////////////
    public function getListTotal($begin_date,$type, $keyword, $rows)
    {
...
";
    ...
    //////////////////////搜索查询数据数目的数据总条数/////////////
    public function getRecordTotal($date,$type, $keyword, $rows)
    {
        $sql="select count(*) as count from (";
...
public function insert($code,$type,$name,$person_code,$service_code, $begin_date,$end_date,$create_time)
{

    $sql = " INSERT INTO village_activity (code,type,name,person_code,service_code, begin_date,end_date,create_time) values (".
