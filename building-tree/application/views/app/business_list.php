...
<!--<?php echo 'x'; ?>-->
	...
	<div class="col-md-10 col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<form class="search_room" action="<?=base_url().'index.php/People/businesslist'?>" method="get">
				<p>
					<input type="text" class="searc_room_text" name="keyword" placeholder="可输入姓名、楼宇名称、经营内容" value="">
					<a id="clear" href="<?=base_url().'index.php/People/businesslist'?>">X</a>
				</p>
		...
		<div class="table_wrap">
			...
			<thead>
				<tr>
					...
					<th data-title="商户code" data-visible="false" data-field="person_code" ></th>
					<th data-title="商户姓" data-visible="false" data-field="lats_name" ></th>
					<th data-title="商户名" data-visible="false" data-field="first_name" ></th>
					<th data-title="性别" data-visible="false" data-field="gender" ></th>
					<th data-title="出生日期" data-visible="false" data-field="birth_date" ></th>
					<th data-title="商户国籍" data-visible="false" data-field="nationality" ></th>
					<th data-title="商户血型" data-visible="false" data-field="blood_type" ></th>
					<th data-title="商户血型名称" data-visible="false" data-field="blood_type_name" ></th>
					<th data-title="人员备注" data-visible="false" data-field="p_remark" ></th>
					<th data-title="商户信息备注" data-visible="false" data-field="biz_remark" ></th>
					...
					<th data-title="商户类型号码" data-visible="false" data-field="biz_type" ></th>
					...
					<th data-field="room" data-title="商铺编号" data-align="center"></th>
...
$(function(){
	...
	$('.fenye_btn').click(function(){
		...
		window.location.href="businesslist?keyword="+search_keyword+"&page=1"+"&effective_date="+search_effective_date+'&biz_type='+search_biz_type+'&building_code='+search_building_code;
	})
	//商户类型筛选
