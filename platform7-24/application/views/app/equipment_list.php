	...
	<div class="col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<div class="search_room msg_search_room">
				<p>
					<input type="text" class="searc_room_text" name="keyword" placeholder="可输入设备名称、设备用途、内部编号" value="">
		...
		<div class="table_wrap">
			<div class="oh pt10">
				...
				<a class="fr add_btn" href="<?=base_url().'index.php/Equipment/equipmentlist'?>">清除筛选</a>
			</div>
			...
			<thead>
				<tr>
					...
					<th data-field="e_name" data-title="设备名称" data-align="center" data-formatter="viewAll"></th>
					...
					<th data-field="internal_no" data-title="内部编号" data-align="center"></th>
					<th data-field="function" data-title="设备用途" data-align="center" data-formatter="viewAll"></th>
	            ...
	            <div class="modal-body building">
	            	<div class="fl person_wrap">
						...
						<p><span class="red_star">*</span>生效日期：
							<input type="text" class="effective_date date form-control" name="effective_date" placeholder="">
						</p>
						...
						<p><span class="red_star">*</span>设备号：
							<input type="text" class="model_input sign" placeholder="请填写设备号" name="sign" value="1">
						</p>
						...
						<p style="padding-left: 13px;">设备用途：
							<input type="text" class="ka_input3 function" name="function" placeholder="请填写设备用途" >
						</p>
						<p style="padding-left: 13px;">内部编号：
							<input type="text" class="ka_input3 internal_no" name="internal_no" placeholder="请填写内部编号" >
						</p>
						<p style="padding-left: 13px;">出厂编号：
					...
					<div class="fr person_wrap">
						...
						<p style="padding-left: 22px;">生产日期：
							<input type="text" class="date production_date form-control" name="production_date" placeholder="请输入生产日期">
						</p>
						...
						<div class="select_wrap select_pull_down select_annual_check">
							<div>
        	...
        	<div class="model_content">
	            ...
	            <div class="modal-body building oh">
		            <div class="fl person_wrap person_detail">
		            	...
		            	<p><span class="des">设备号：</span>
		            		<span class="sign col_37A"></span>
		            	</p>
        	...
        	<div class="model_content">
                ...
                <div class="modal-body building">
                	<div class="fl person_wrap">
    					...
    					<p style="padding-left: 22px;">内部编号：
    						<input type="text" class="ka_input3 internal_no" name="internal_no" placeholder="请填写内部编号" >
    					</p>
    				...
    				<div class="fr person_wrap">
    					...
    					<p style="padding-left: 22px;">生产日期：
    						<input type="text" class="date production_date form-control" name="production_date" placeholder="">
    					</p>
    					<div class="select_pull_down select_wrap select_parent_code">
    						<div>
    							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;设备父节点：
    					...
    					<div class="select_pull_down select_wrap select_regular_check">
    						<div>
    							<span class="red_star">*</span>巡检周期：
    							<input type="text" class="model_input regular_check ka_input3" placeholder="" name="regular_check" data-ajax="" readonly>
    						</div>
    						<div class="ka_drop">
    							<div class="ka_drop_list">
    							<ul>
...
$(function(){
	...
	$('.search_room #clear').click(function(){
		window.location.href="equipmentlist?keyword=&page=1"+"&effective_date="+search_effective_date+'&equipment_type='+search_equipment_type+'&regular_check='+search_regular_check+'&building_code='+search_building_code;
	})
