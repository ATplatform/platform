	...
	<div class="col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<div class="search_room msg_search_room" method="get">
				<p>
					<input type="text" class="searc_room_text" name="keyword" placeholder="可输入信息标题或者推送对象" value="">
        ...
        <div class="modal-content model_wrap">
        	<div class="model_content">
	            ...
	            <div class="modal-body building">
					...
					<div class="select_wrap create_type_wrap" style="margin-left:106px;display: none;">
						<div class="select_pull_down fl">
							...
							<div class="ka_drop" style="left:1px;width: 130px;">
								<div class="ka_drop_list">
								<ul>
