...
<!--<?php echo 'x'; ?>-->
    ...
    <!-- 物资数据-->
        <div class="table_wrap">
           <div class="oh pt10">
                <span class="fr add_btn" data-target="#add_Item" data-toggle="modal">新增活动信息</span>
            </div>
            <table id="table"
                ...
                <tr>
                    ...
                    <th data-title="活动名称" data-align="center" data-field="activity_code"></th>
                    <th data-title="活动类型" data-align="center" data-field="type_name"></th>
                    <th  data-title="物业负责人" data-align="center" data-field="service_name"></th>
                    <th data-title="有兴趣的业主" data-align="center" data-field="person_name"></th>
                ...
                <div class="modal-content model_wrap">
                    <div class="model_content">
                        <div class="building_header">
                            <h4 class="modal-title tac">新增活动信息</h4>
                        </div>
                        <div class="modal-body building add_Item">
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动名称：<span class="code" style="margin-left:26px;"></span></p>
                            <div class="select_wrap select_pull_down">
                                ...
                                <div class="ka_drop" style="margin-left:50px;width: 300px;">
                            ...
                            <p><span class="red_star">*</span>物业负责人：
                                <input type="text" class="model_input service_code" name="service_code" value=""/ >
                            </p>
