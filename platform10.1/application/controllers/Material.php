...
class Material extends CI_Controller
{
    ...
    /*    foreach ($building_code as $row) {
        ...
        $res = $this->Material_model->insertMaterial($code, $effective_date, $effective_status, $name, $pcs, $material_type, $building_code, $function,$supplier, $internal_no, $initial_no, $remark, $create_time);
        if ($res) {
            $data['message'] = '新增物资成功';
            //新增成功后,生成一张二维码图片
            //得到楼宇信息
