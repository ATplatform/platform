...
<!--<?php echo 'x'; ?>-->
        ...
        <div >
        <div class="show fl" style="width:40%;margin-left:40px;">
   ...
   <p > 当前所在社区: <input type="text"  name="name" value="" class="col_37A "></p>
    ...
    <p >社区简介:<input type="text"  name="brief" value=""  style="width:400px;" class="col_37A "></p>      <!--  <textarea class="col_37A " cols="5"></textarea>-->
    <p >所在城市:<input type="text"  name="city" value="" class="col_37A "></p>
            <p >社区位置:<input type="text"  name="location" value="" class="col_37A " style="width:100px;"> 经度:<input type="text"  name="longitude" value="" class="col_37A " style="width:100px;">
    ...
    <p >总车位数:<input type="text"  name="parking_lots" value="" class="col_37A "></p>
            <div id="container" style="height:275px;width:70%;">

            </div>
    </div>

        <div  class="fl"  style="width:50%;height:100%px;">
            <div >
                <img   class="villageimg " src="http://localhost/platform10/upload/village_img/100003.jpg" alt="#" >
            </div>
        </div>
    </div>
    </div>
