    ...
    return   {
       ...
       ,
        ...
        findinsert:function(){
            ...
            if(!this.insert.must.code) {openLayer('请输入车辆编码');return;}
            ...
            if(!this.insert.must.begin_date) {openLayer('请输入授权结束日期');return;}
...
switch(init_search_index_1){
    case 't':$('.search_wrap .search_1').val('常驻');break;
    case 'f':$('.search_wrap .search_1').val('临时');break;

    default:$('.search_wrap .search_1').val('常驻 / 临时');break;
}
