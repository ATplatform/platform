...
$(function(){
	...
	$('.search_wrap .effective_date').datetimepicker().on('changeDate', function(ev){
        ...
        window.location.href="residentlist?keyword="+search_keyword+"&page=1"+"&effective_date="+date+'&household_type='+search_household_type+'&person_type='+search_person_type;
    })
    //点击搜索按钮,跳转
    $('.search_room button[type="submit"]').click(function(){
    	...
    	window.location.href="residentlist?keyword="+keyword+"&page=1"+"&effective_date="+search_effective_date+'&household_type='+search_household_type+'&person_type='+search_person_type;
    })
    //清除搜索条件
