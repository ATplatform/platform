<div class="col-md-2 col-sm-12 pl0 pr0 ml0 mr0">
	...
	<li>
		...
		<ul id="BuildingSetting" 
			...
			?>   
		aria-expanded="true" >
			<li><a href=""><i class="glyphicon"></i>社区信息管理</a></li>
	...
	<li>
		<a href="#EquipmentSetting" class="nav-header " data-toggle="collapse"
			<?php if($nav=="equipmentlist") {echo 'aria-expanded="true"';} ?> 
		>
		...
		<ul id="EquipmentSetting" 
			...
			?>   
		aria-expanded="true" >
			<li><a href=""><i class="glyphicon"></i>设备运营分析</a></li>
			...
			<li><a href=""><i class="glyphicon"></i>设备授权管理</a></li>
			<li><a href=""><i class="glyphicon"></i>设备状态管理</a></li>
			<li><a href=""><i class="glyphicon"></i>设备维保管理</a></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul id="VehicleSetting" 
			...
			?>   
		aria-expanded="true" >
			<li <?php if($nav=="vehiclelist") {echo 'class="active"';} ?> ><a href=""><i class="glyphicon"></i>车辆信息管理</a></li>
			<li><a href=""><i class="glyphicon"></i>车辆进出记录</a></li>
			<li><a href=""><i class="glyphicon"></i>车辆缴费记录</a></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul id="FinanceSetting" 
			...
			?>   
		aria-expanded="true" >
			<li><a href=""><i class="glyphicon"></i>社区经营分析</a></li>
			<li><a href=""><i class="glyphicon"></i>车辆缴费管理</a></li>
			<li><a href=""><i class="glyphicon"></i>物业费缴费管理</a></li>
			<li><a href=""><i class="glyphicon"></i>其他费用缴费管理</a></li>
		</ul>
	</li>
	...
	<li>
	    ...
	    <ul id="ContractSetting"
	        ...
	        ?>
	        aria-expanded="true" >
	        <li <?php if($nav=="contractList") {echo 'class="active"';} ?> ><a href=""><i class="glyphicon"></i>合同管理列表</a></li>
	    </ul>
	</li>
	...
	<li>
	    ...
	    <ul id="ActivitySetting"
	        ...
	        ?>
	        aria-expanded="true" >
	        <li <?php if($nav=="activityList") {echo 'class="active"';} ?> ><a href=""><i class="glyphicon"></i>住户活动圈</a></li>
	        <li><a href=""><i class="glyphicon"></i>住户活动管理</a></li>
	    </ul>
	</li>
	...
	<li>
	    ...
	    <ul id="FunctionSetting"
	        ...
	        ?>
	        aria-expanded="true" >
	        <li><a href=""><i class="glyphicon"></i>二维码打印</a></li>
	    </ul>
	</li>
