...
function html_render(index){
   ...
   /*     var  time_html='';
    ...
    this.initial_all=function(index) {
        ...
        if(index[n]['search']=='yes' || index[n]['method']=='time' ||index[n]['method']=='username'||index[n]['method']=='building'){
