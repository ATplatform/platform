...
var platform_index={
    service_type:{
        ...
        input:'服务类型',
        method:'select',
ajax:{101:'公共服务',201:'家政维修-墙体天花玻璃类',202:'家政维修-门锁类',203:'家政维修-给排水类',204:'家政维修-照明类',205:'家政维修-线路类',206:'家政维修-家电',301:'家政清洁-大面积清洁',302:'家政清洁-常规清洁',401:'家政服务-桶装水业务',402:'家政服务-定向钟点工',403:'家政服务-代寄收快递/包裹',404:'家政服务-代购业务',405:'家政服务-跑腿业务',501:'租借服务',502:'绿化服务',503:'车辆服务',999:'其他'},
        disabledonly:'update'
    },
    service_code:{
        search:'no',
    ...
    info_manage:{
        ...
        rewrite:{title:'更新服务收费信息',css:'fa-pencil-square-o',content:getrewrite}
    },
    pagechange:{urlparam:{route:'',page:''}, pagesize:'', total:'',page:''},
    router:{
        root:getRootPath()+'/index.php/Moneypay/service_fee',
        get:'getList_service_fee',
        insert:'insert',
        getfloor:'getfloor',
