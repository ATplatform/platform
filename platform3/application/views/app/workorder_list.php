...
<!--<?php echo 'x'; ?>-->
    ...
    <div class="searc_bar search_wrap " id="search_wrap" >
     ...
     <a href="javascript:;" id="treeNav" class="treeWrap treeWrapSearch"><span></span></a>
            ...
            <!--筛选工单类型-->
        <div class="Search_Item_wrap order_kind_search_wrap select_pull_down query_wrap col_37A fl">
            <div >
                <input type="text"  class="model_input order_kind ka_input3" placeholder="工单类型" name="order_kind" data-ajax="" value="" readonly style="width:100px;" >
            </div>
    ...
    <!-- 物资数据-->
          ...
          <!--  <div class="oh pt10">
            ...
            <table id="table"
                ...
                <tr>
                    ...
                    <th  data-title="工单类型" data-align="center" data-field="order_kind_name"></th>
        ...
        <ul class="pager" page='<? $page ?>'>
            <?php
            $first=base_url().'index.php/Workorder/workorderList?page=1&parent_code='.$parent_code.'&building_code='.$building_code.'&create_type='.$create_type.'&keyword='.$keyword.'&create_time='.$create_time.'&order_kind='.$order_kind;
            echo  " <li><a href='".$first."' id='first'>首 页</a></li>";
            if($page>1) {
                $url=base_url().'index.php/Workorder/workorderList?page='.($page-1).'&parent_code='.$parent_code.'&building_code='.$building_code.'&create_type='.$create_type.'&keyword='.$keyword.'&create_time='.$create_time.'&order_kind='.$order_kind;
            ...
            $last=base_url().'index.php/Workorder/workorderList?page='.$total.'&parent_code='.$parent_code.'&building_code='.$building_code.'&create_type='.$create_type.'&keyword='.$keyword.'&create_time='.$create_time.'&order_kind='.$order_kind;
                        ...
                        <div class="modal-body building oh">
                            <div class="fl person_wrap person_detail">
                                ...
                                <p><span class="des">工单类型：</span>
                                    <span class="order_kind_name col_37A"></span>
                                </p>
                                ...
                                <p><span class="des">处理完成图片：</span>
                                    <span class="process_pic col_37A"></span>
                                </p>
...
<input type="hidden" value='<?php echo $order_kind;?>' name="order_kinds" />
