...
<!--<?php echo 'x'; ?>-->
	<div class="col-sm-12 main_wrap">
		...
		<div class="table_wrap">
			<div class="oh pt10">
				<a class="fr add_btn" href="<?=base_url().'index.php/Permission/videoitclist'?>">清除筛选</a>
			</div>
			<table id="table"
			...
			<thead>
				<tr>
					...
					<th data-field="call_entry_name" data-title="设备名称" data-align="center"></th>
					<th data-field="bell_time" data-title="呼叫时间" data-align="center"></th>
					<th data-field="call_eqp_name" data-title="呼叫对象" data-align="center"></th>
					<th data-field="call_duration" data-title="呼叫时长" data-align="center"></th>
					<th data-field="answer_duration" data-title="通话时长" data-align="center"></th>
					<th data-field="full_name" data-title="应答人" data-align="center"></th>
					<th data-field="if_open" data-title="是否开门" data-align="center"></th>
		...
		<ul class="pager" page='<? $page ?>'>
		    <?php
		       $first=base_url().'index.php/Permission/videoitclist?page=1&keyword='.$keyword.'&equipment_type='.$equipment_type.'&building_code='.$building_code.'&push_start_date='.$push_start_date.'&push_end_date='.$push_end_date;	
		       echo  " <li><a href='".$first."' id='first'>首 页</a></li>";
		    if($page>1) {
					$url=base_url().'index.php/Permission/videoitclist?page='.($page-1).'&keyword='.$keyword.'&equipment_type='.$equipment_type.'&building_code='.$building_code.'&push_start_date='.$push_start_date.'&push_end_date='.$push_end_date; 
		    ...
		    $last=base_url().'index.php/Permission/videoitclist?page='.$total.'&keyword='.$keyword.'&equipment_type='.$equipment_type.'&building_code='.$building_code.'&push_start_date='.$push_start_date.'&push_end_date='.$push_end_date;
        ...
        <div class="modal-content model_wrap">
        	<div class="model_content">
	            <div class="building_header">
	                <h4 class="modal-title tac">对讲记录详情</h4>
	            </div>
	            <div class="modal-body building oh">
	            	<p><span class="des">设备名称：</span>
	            		<span class="call_entry_name col_37A"></span>
	            	</p>
	            	<p><span class="des">呼叫对象：</span>
	            		<span class="call_eqp_name col_37A"></span>
	            	</p>
	            	<p><span class="des">设备地址：</span>
	            		<span class="building_name col_37A"></span>
	            	</p>
	            	<p><span class="des">呼叫时间：</span>
	            		<span class="bell_time col_37A"></span>
	            	</p>
	            	<p><span class="des">呼叫时长：</span>
	            		<span class="call_duration col_37A"></span>
	            	</p>
	            	<p><span class="des">通话时长：</span>
	            		<span class="answer_duration col_37A"></span>
	            	</p>
	            	<p><span class="des">应答人：&nbsp;&nbsp;</span>
	            		<span class="full_name col_37A"></span>
	            	</p>
	            	<p><span class="des">是否开门：</span>
	            		<span class="if_open col_37A"></span>
	            	</p>
	            	<div class="if_open_wrap">
...
$(function(){
	...
	$('#table').bootstrapTable({
		method: "get",
		undefinedText:' ',
		url:getRootPath()+'/index.php/Permission/getVideoItcList?page='+page+'&keyword='+search_keyword+'&equipment_type='+search_equipment_type+'&building_code='+search_building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date,
		dataType:'json',
	...
	$('.fenye_btn').click(function(){
		...
		window.location.href="videoitclist?keyword="+search_keyword+"&page="+page+'&equipment_type='+search_equipment_type+'&building_code='+search_building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date;
	})
	...
	$('#search_wrap .push_start_date,#search_wrap .push_end_date').datetimepicker().on('changeDate',function(e){
		...
		if(startDate>endDate){
			...
			return;
		 	...
		 	window.location.href="videoitclist?keyword="+search_keyword+"&page=1"+'&equipment_type='+search_equipment_type+'&building_code='+search_building_code+'&push_start_date='+startDate+'&push_end_date='+endDate;
		}
	});
	...
	$('.search_wrap .equipment_type_wrap .ka_drop_list li').click(function(){
		...
		window.location.href="videoitclist?keyword="+search_keyword+"&page=1"+'&equipment_type='+equipment_type+'&building_code='+search_building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date;
	})
	//树形菜单点击筛选
	$('#treeNav>span').on("select_node.jstree", function (e, node) {
	  var building_code = node.node.original.code;
	  window.location.href="videoitclist?keyword="+search_keyword+"&page=1"+'&equipment_type='+search_equipment_type+'&building_code='+building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date;
	})
	//点击搜索按钮,跳转
	$('.search_room button[type="submit"]').click(function(){
		...
		window.location.href="videoitclist?keyword="+keyword+"&page=1"+'&equipment_type='+search_equipment_type+'&building_code='+search_building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date;
	})
	//清除条件
	$('.search_room #clear').click(function(){
		window.location.href="videoitclist?keyword=&page=1"+'&equipment_type='+search_equipment_type+'&building_code='+search_building_code+'&push_start_date='+search_start_date+'&push_end_date='+search_end_date;
	})
})
</script>
<script src='<?=base_url().'application/views/plugin/app/js/videoitc_list.js'?>'></script>
</body>
</html>