...
$(function(){
  //给有楼宇层级筛选的列表赋值楼宇名称
    ...
    $('#treeNav>span').on(" before_open.jstree", function (e, data) {
        console.log( data )
        $('#treeNav>span').css({
            "height": "300px",
            "width":"200px",
    ...
    $('#treeNav>span').on(" after_close.jstree", function (e, data) {
        console.log( 111 )
        console.log( data )
    ...
    $(' #treeNavAdd>span').on(" before_open.jstree", function (e, data) {
        console.log( data )
        $(' #treeNavAdd>span').css({
            "height": "300px",
            "overflow": "auto"
    ...
    $(' #treeNavAdd>span').on(" after_close.jstree", function (e, data) {
        console.log( 111 )
        console.log( data )
        if(data.node.parents.length==1){
            $('#treeNav>span').css({
    ...
    $('  #treeNavWrite>span').on(" before_open.jstree", function (e, data) {
        console.log( data )
        $('  #treeNavWrite>span').css({
            "height": "300px",
            "overflow": "auto"
        })
    })

    $('  #treeNavWrite>span>span').on(" after_close.jstree", function (e, data) {
        console.log( 111 )
        console.log( data )
        if(data.node.parents.length==1){
            $('  #treeNavWrite>span').css({
