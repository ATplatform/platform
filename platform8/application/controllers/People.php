...
class People extends CI_Controller{
	...
	public function residentlist(){
		...
		if(!empty($building_code)){
			$this->load->model('People_model');
			$buildings = $this->People_model->getBuildingByCode($building_code);
			$level = $buildings['level'];
		}
		//得到住户人员总数
		$total = $this->People_model->getResidentListTotal($building_code,$level,$if_disabled,$birth_begin,$birth_end,$household_type,$effective_date,$keyword,$this->user_per_page);
	...
	public function updatePeople(){
		...
		if(!empty($search_building_code)){
			$this->load->model('People_model');
			$buildings = $this->People_model->getBuildingByCode($search_building_code);
			$level = $buildings['level'];
		}
		//得到住户人员总数
		$data['residentlist_total'] = $this->People_model->getResidentListTotal($search_building_code,$level,$if_disabled,$birth_begin,$birth_end,$search_household_type,$search_effective_date,$search_keyword,$this->user_per_page);
		//得到商户人员总数
		$data['businesslist_total'] = $this->People_model->getBusinessListTotal($search_effective_date,$search_biz_type,$search_building_code,$level,$search_keyword,$this->user_per_page);
		print_r(json_encode($data));
	}
	...
	public function getResidentList(){
		...
		//获得住户列表
		$res = $this->People_model->getResidentList($building_code,$level,$if_disabled,$birth_begin,$birth_end,$household_type,$effective_date,$keyword,$page,$this->user_per_page);
		echo $res;	
	}
	...
	public function updatePersonBuilding(){
		...
		//得到住户人员总数
		$data['residentlist_total'] = $this->People_model->getResidentListTotal($search_building_code,$level,$level,$if_disabled,$birth_begin,$birth_end,$search_household_type,$search_effective_date,$search_keyword,$this->user_per_page);
		//得到商户人员总数
	...
	public function getPersonPosition(){
		...
		foreach($territorys as $key => $row){
			$result[$key] = $this->People_model->getBuildingByCode($row);
		}
	...
	public function businesslist(){
		...
		$this->load->model('People_model');
		$total=$this->People_model->getBusinessListTotal($effective_date,$biz_type,$building_code,$level,$keyword,$this->user_per_page);
	...
	public function getBusinessList(){
		...
		//获得商户列表
		$res = $this->People_model->getBusinessList($effective_date,$building_code,$level,$biz_type,$keyword,$page,$this->user_per_page);
		echo $res;	
	}
