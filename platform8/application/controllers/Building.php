...
class Building extends CI_Controller{
	...
	public function buildinglist(){
		...
		$this->load->model('Building_model');
		$total=$this->Building_model->getBuildingTotal($keyword,$id,$parent_code,$this->user_per_page);
		//树形菜单
	...
	public function getBuildingsList(){
		...
		$this->load->model('Building_model');
		$page = $page?$page:'1';
		$data = $this->Building_model->getBuildingsList($keyword,$id,$parent_code,$page,$this->user_per_page);
		echo $data;
	}
	...
	public function updateBuilding(){
		...
		$total=$this->Building_model->getBuildingTotal($keyword,$search_id,$search_parent_code,$this->user_per_page);
		$data['total'] = $total;
		print_r(json_encode($data));
	}
