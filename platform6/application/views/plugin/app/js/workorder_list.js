...
search(List,'creat_time','building_code','parent_code','create_type','order_type')
...
$('#treeNav>span').on("select_node.jstree", function (e, node) {
    ...
    List[keys[1]]=building_code
    List[keys[2]]=parent_code
    window.location.href=href(List)
})
