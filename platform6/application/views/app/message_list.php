...
<!--<?php echo 'x'; ?>-->
	<div class="col-md-10 col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<div class="search_room msg_search_room" method="get">
				<p>
	            ...
	            <div class="modal-body building">
					...
					<div class="if_bill_wrap">
						...
						<span>
							...
							<label for="radio-3-1" style="margin-left: 50px;"></label>是
							
							<span style="margin-left: 10px;">缴费金额：</span>
							<input type="text" value="" class="bill_amount" name="bill_amount" readonly />元
						</span>
					</div>
					...
					<div class="select_wrap create_type_wrap" style="margin-left:106px;">
						<div class="select_pull_down">
							<input type="text" class="model_input cycle_type ka_input3" placeholder="循环周期" name="level" style="margin-bottom: 20px;" data-ajax="" readonly="">
							<div class="ka_drop" style="left:1px;">
								<div class="ka_drop_list">
								<ul>
						...
						<div>
							...
							<input style="display: inline-block;width: 200px;" type="text" value="" class="date form-control push_end_date" name="push_end_date"  />
						</div>

					</div>
					

					<p class="push_start_date_wrap" style="display: none;"><span class="red_star">*</span>推送时间：
						<input type="text" class="push_start_date form-control" name="push_start_date">
					</p>
					...
					<p class="select_wrap">
						<span class="red_star">*</span>消息标题：
						<input type="text" class="msg_title" name="msg_title" maxlength="32">
					</p>
					
					<!--编辑器-->
					<script id="editor" type="text/plain" style="width:568px;height:500px;"></script>	
...
<div class="modal fade" id="confirm_message" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog"  style="width: 630px;">
        <div class="modal-content model_wrap">
        	<div class="model_content">
	            <div class="modal-body building">
					<iframe  class="msg_html" src="http://localhost/platform/messagelist/1000001.html" width="320" height="568" scrolling="auto" align="center">   
					</iframe>
	            </div>
            ...
            <div class="modal_footer bg_eee">
            	<p class="tac pb17">
                	<span class="col_37A push">推送</span>
                	<span class="col_37A add">保存</span>
                	<span class="col_FFA cancle" data-dismiss="modal">取消</span>
            	</p>
            </div>
        </div><!-- /.modal-content -->
        ...
        <div class="modal-content model_wrap">
        	<div class="model_content">
	            ...
	            <div class="modal-body building oh">
					...
					<p>截止时间：
						<input style="display: inline-block;width: 200px;float: none;" type="text" value="" class="date form-control end_date" name="end_date"  />
					</p>
					<p>消息标题：
						<span class="msg_title col_37A"></span>
					</p>
...
$(function(){
	...
	$('.search_room #clear').click(function(){
		window.location.href="messagelist?page=1"+"&msg_type="+search_msg_type+'&cycle_type='+search_cycle_type+'&push_start_date='+today_begin+'&push_end_date='+today_end;
	})
