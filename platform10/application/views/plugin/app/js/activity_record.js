...
if(page>1){
    $('.pager .prevpage').removeClass('disabled')
    $('.pager .prevpage').addClass('active')
    $('.pager #prev ').attr("href",prevhref)
} else {
    $('.pager .prevpage').removeClass('active')
    $('.pager .prevpage').addClass('disabled')
    $('.pager #prev ').attr("href",'javascript:void(0);')
}

if(page<total){
    $('.pager .nextpage').removeClass('disabled')
    $('.pager .nextpage').addClass('active')
    $('.pager #next ').attr("href",nexthref)
} else{
    $('.pager .nextpage').removeClass('active')
