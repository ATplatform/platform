			...
			if(data!='false'){
				...
				for(var i=0;i<data.length;i++){
					...
					var html = '<div class="single_person" data-code="'+d['code']+'"><a class="fl add"><i class="fa fa-trash-o fa-lg fa-plus-circle"></i></a>'
								...
								+'<span class="eqip_name" title="'+d['name']+'">'+d['name']+'</span>'
								+'<span class="address" title="'+d['building_name']+'">'+d['building_name']+'</span>'
								+'</div>';
					// console.log(html);
...
$(document).on('click','.search_equipment_wrap .single_person .add',function(){
	...
	var html = '<li data-code="'+code +'" id="'+code+'"><span class="name">'+code+'</span><span class="eqip_name" title="'+eqip_name+'">'+eqip_name+'</span><span class="address" title="'+address+'">'+address+'</span><i class="fa fa-close"></i></li>';
		//只能添加一个
