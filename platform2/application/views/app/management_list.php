...
<!--<?php echo 'x'; ?>-->
	...
	<div class="col-md-10 col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<form class="search_room" action="<?=base_url().'index.php/People/managementlist'?>" method="get">
				<p>
					<input type="text" class="searc_room_text" name="keyword" placeholder="可输入姓名、职位名称" value="">
					<a id="clear" href="<?=base_url().'index.php/People/managementlist'?>">X</a>
				</p>
		...
		<div class="table_wrap">
			...
			<thead>
				<tr>
					...
					<th data-title="人员code" data-visible="false" data-field="person_code" ></th>
					<th data-title="人员姓" data-visible="false" data-field="lats_name" ></th>
					<th data-title="人员名" data-visible="false" data-field="first_name" ></th>
					<th data-title="性别" data-visible="false" data-field="gender" ></th>
					<th data-title="出生日期" data-visible="false" data-field="birth_date" ></th>
					<th data-title="人员国籍" data-visible="false" data-field="nationality" ></th>
					<th data-title="人员血型" data-visible="false" data-field="blood_type" ></th>
					<th data-title="人员血型名称" data-visible="false" data-field="blood_type_name" ></th>
					<th data-title="人员备注" data-visible="false" data-field="remark" ></th>
					...
					<th data-title="人员类型号码" data-visible="false" data-field="household_type" ></th>
					<th data-title="人员关系code" data-visible="false" data-field="pp_code" ></th>
					...
					<th data-field="position_code" data-title="员工编号" data-align="center"></th>
					<th data-field="hire_date" data-title="入职日期" data-align="center"></th>
					<th data-field="territory_name" data-title="管理区域" data-align="center"></th>
	            ...
	            <div class="modal-body building oh">
					...
					<div class="fr person_wrap person_detail">
						...
						<p><span class="des">管理区域：</span>
							<span class="territory_name col_37A"></span>
						</p>
...
<div class="modal fade" id="write_person" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog"  style="width: 890px;">
        <div class="modal-content model_wrap">
            ...
            <div class="modal_footer bg_eee">
            	<p class="tac pb17">
                	<span class="col_37A save">保存人员信息</span>
                	<span class="col_FFA cancle"  data-dismiss="modal">取消</span>
            	</p>
            </div>
        </div><!-- /.modal-content -->
        ...
        <div class="modal-content model_wrap">
        	<div class="model_content">
	            ...
	            <div class="modal-body building oh">
		            ...
		            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;人员编号：
    					<span class="person_code" data-ajax=""></span>
    				</p>
					<p>
						<span class="des">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;入职日期：</span>
						<span class="hire_date col_37A" style="margin-left: 20px;"></span>
					</p>
					<p class="select_buliding_wrap">
						<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;管理区域：</span>
						<span class="select_buliding">
					...
					<p>
						...
						<span class="employee_no col_37A" style="margin-left: 20px;"></span>
					</p>
