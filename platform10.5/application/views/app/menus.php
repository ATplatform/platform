<div class="leftNav col-sm-12 pl0 pr0 ml0 mr0">
	...
	<li>
		...
		aria-expanded="true" >
            ...
            <li><a href="<?=base_url().'index.php/Building/notfond'?>"><i class="glyphicon"></i>车辆授权信息</a></li>
            <li><a href="<?=base_url().'index.php/Building/notfond'?>"><i class="glyphicon"></i>小区车位管理</a></li>
