...
public function insert($code,$type,$name,$person_code,$service_code, $begin_date,$end_date,$qr_code,$create_time)
{
    ...
    public function insertRecord($code,$person_code,$service_code, $date,$remark,$create_time)
    {

        $sql = " INSERT INTO village_activity_rcd (activity_code,person_code,service_code, date,remark,create_time) values (".
