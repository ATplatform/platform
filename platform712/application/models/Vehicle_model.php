...
public function insert($village_id,$code,$effective_date,$licence,$owner,$color, $model,$remark,$vehicle_type,$person_code,$effective_status,$if_resident,$if_electro,$if_temp,$auz_code,$auz_person_code,$begin_date,$end_date,$auz_remark,$create_time)
{

    $sql = " INSERT INTO village_vehicle (village_id,code,effective_date,licence,owner,color, model,remark,vehicle_type,person_code,effective_status,if_resident,if_electro,if_temp,create_time) values (".
