...
$(function(){
	...
	var search_msg_type = getUrlParam('effective_date');
	var search_cycle_type = getUrlParam('effective_date');
	var search_start_date  = getUrlParam('effective_date');
	var search_end_date  = getUrlParam('effective_date');
