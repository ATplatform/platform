...
$(document).on('click','.search_equipment_wrap .single_person .add',function(){
	...
	var html = '<li data-code="'+code +'" id="'+code+'"><span class="name">'+code+'</span><span class="eqip_name">'+eqip_name+'</span><span class="address" title="'+address+'">'+address+'</span><i class="fa fa-close"></i></li>';
		//只能添加一个
