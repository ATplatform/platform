    ...
    return   {
       ...
       ,
        ...
        findinsert:function(){
            ...
            this.insert.input.additional=$('input[name="additionals"]').val()
...
search(List,'begin_date','type','level','keyword')
insert(router.getLatestCode,router.getposition_code,router.insert,router.getadditionalUrl,List)
