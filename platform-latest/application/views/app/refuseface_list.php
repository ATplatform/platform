	...
	<div class="col-sm-12 main_wrap">
		<div class="searc_bar search_wrap" id="search_wrap">
			...
			<div class="search_room msg_search_room">
				<p>
					<input type="text" class="searc_room_text" name="keyword" placeholder="可输入姓名、一卡通卡号" value="">
		...
		<div class="table_wrap">
			...
			<thead>
				<tr>
					...
					<th data-field="card_no" data-title="一卡通号" data-align="center"></th>
					...
					<div class="">
						...
						<div class="fl">
							...
							<div class="select_buliding_wrap" style="margin-left: 20px;margin-top: 10px;">
								...
								<span class="select_buliding" style="width: 130px;overflow: hidden;">
								</span>
							</div>
						</div>
						<div class="clear"></div>
