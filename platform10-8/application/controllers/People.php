...
class People extends CI_Controller{
	...
	public function updatePersonBuilding(){
		...
		//得到住户人员总数
		$residentlist_total = $this->People_model->getResidentListTotal($search_building_code,$level,$if_disabled,$birth_begin,$birth_end,$search_household_type,$search_effective_date,$search_keyword,$this->user_per_page);
