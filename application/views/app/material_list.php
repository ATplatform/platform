...
<!--<?php echo 'x'; ?>-->
    ...
    <div class="searc_bar search_wrap" id="search_wrap" >
        ...
        <!-- 筛选条件 地点-->
        <div class="select_pull_down query_wrap col_37A fl select_parent_code">
            <div>
                <input type="text" class="model_input building_code_select ka_input3" placeholder="地点" name="building_code_select" data-ajax="" readonly>
            </div>
            <div class="ka_drop " style="display: none;">
                    ...
                    <div class="model_content">
                      ...
                      <!--      <div class="select_wrap select_pull_down">
                            ...
                            <div class="select_wrap select_pull_down select_parent_code">
                                <div><span class="red_star">*</span>地点：
                                    <input type="text" class="model_input parent_code ka_input3" placeholder="请输入地点"  name="building_code"  data-ajax="" readonly />
                                </div>
                                <div class="ka_drop">
                                    <div class="ka_drop_list buildings">
                                        <ul>
